...
如果有美区AppleID的话，可以直接上App Store下载Fair VPN（免费）、UltrasurfVPN（免费）、oneclick（免费）、Shadowrocket、Potatso Lite、Potatso、wingy、Kitsunebi等。美区AppleID可以淘宝购买（“苹果ID”已被屏蔽。输入关键词“苹果”，在下拉提示中选择与ID相关的搜索结果），或者也可以到第三方平台如：https://taohao.me/product （网友分享网址）购买Apple ID。
